...
class Settings:
    ...
    understanding_model: str = os.getenv("UNDERSTANDING_MODEL", "")
    solver_model: str = os.getenv("SOLVER_MODEL", "")
    diagnosis_model: str = os.getenv("DIAGNOSIS_MODEL", "")
    tutor_model: str = os.getenv("TUTOR_MODEL", "")
    ...
    pdf_extractor_url: str = os.getenv("PDF_EXTRACTOR_URL", "")
